...
function Welcome() {
  ...
  <h2>This page lists info about the different teams in the NCAA March Madness Tournament</h2>
  </header>);
}

class Team extends React.Component <{school:string, city:string, name:string, state:string}> { //Component because its a class
  render() {
    
    const oneTeam = this.props; //Refers to the elipses down below
...
function Teamlist() {
  return (
    ...
    </div>  //Accesses the array and finds element 0, 1 and 2
  ); 
}
